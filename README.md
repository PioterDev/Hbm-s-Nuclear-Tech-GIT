...
The latest version can be found on [CurseForge](https://www.curseforge.com/minecraft/mc-mods/hbms-nuclear-tech-mod-extended-edition) or [Modrinth](https://modrinth.com/mod/ntm-extended) or under the [Releases page](https://github.com/PioterDev/Hbm-s-Nuclear-Tech-GIT/releases). (actually not because this is a different version)

If you have question or suggestions you can post them on our [NTM Extended Discord](https://discord.gg/Auq95eCEtD) (actually not because this is a different version)
